...
using ErrorOr;
using UserManagement.API.Common.Http;

namespace UserManagement.Api.Common.Errors
{
    public sealed class UserManagementProblemDetailsFactory : ProblemDetailsFactory
    {
        ...
        public UserManagementProblemDetailsFactory(
